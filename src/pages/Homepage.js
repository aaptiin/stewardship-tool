...
class Homepage extends React.Component {
    ...
    render() {
        return (
            <div className="flex items-center justify-center bg-blue-100 relative overflow-hidden md:h-screen py-4">
